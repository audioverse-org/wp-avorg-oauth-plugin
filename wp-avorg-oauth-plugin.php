...
define( 'OAUTH2__AUTHORIZE_URI', 'https://www.audioverse.org.lan/oauth/authorize' );
define( 'OAUTH2__CLIENT_ID', 12 );
define( 'OUATH2__API_USER_URI', 'http://localhost:8000/auth/user');
